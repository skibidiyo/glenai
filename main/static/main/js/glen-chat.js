document.addEventListener('DOMContentLoaded', () => {
  ...
  const replies = [
    ...
    { test: /mineral|personality|work style|assessment/i, message: 'Discover your work style and strengths through Glen’s mineral archetype experience.', actions: [{ label: 'Start Assessment', href: '/personality/' }] },
    { test: /leave|holiday|vacation|time off/i, message: 'You can request annual leave through the employee portal. You may also want to review the leave policy before submitting your request.', actions: [{ label: 'View policy', demo: true }] },
